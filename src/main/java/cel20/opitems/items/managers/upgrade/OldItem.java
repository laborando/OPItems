...
/**
 * Class for matching old cel20.items with specific materials and enchantments with their respective id <br>
 * Old versions of OPItems used enchantments instead of ids to differentiate cel20.items
 */
