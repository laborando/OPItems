...
public class AutoItems {
    ...
    /**
     * Inits automated scheduled removal of dropped cel20.items
     *
     * @param delay
     * @param warning_sek
     */
    public static void innitAutoRemove(int delay, int warning_sek) {
        ...
        removalTask = new BukkitRunnable() {
            ...
            public void run() {
                ...
                Bukkit.broadcastMessage(ChatColor.BOLD + "" + ChatColor.DARK_RED + "WARNING: All loaded an dropper cel20.items will be deleted in " + warning_sek + " seconds!");
