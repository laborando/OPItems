/*
bStats Metrics Class under MIT (?)
Version: 3.1.0 (?)
Source:
...
public class Metrics {
            ...
            config
                    ...
                    .header(
                            "bStats (https://bStats.org) collects some basic information for plugin authors, like how\n"
                                    ...
                                    + "performance penalty associated with having cel20.metrics enabled, and data sent to bStats is fully\n"
                                    + "anonymous.")
                    .copyDefaults(true);
            try {
    ...
    public static class MetricsBase {
            ...
            scheduler.execute(
                    () -> {
                        try {
                            ...
                            if (logErrors) {
                                errorLogger.accept("Could not submit bStats cel20.metrics data", e);
                            }
                        }
                    });
        }
        ...
        private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
            if (logSentData) {
                infoLogger.accept("Sent bStats cel20.metrics data: " + data.toString());
            }
