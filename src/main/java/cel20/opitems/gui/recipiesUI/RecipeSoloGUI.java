...
public class RecipeSoloGUI {


    public static void showSoloRecipe(Player player, int id, int retPage) {


        Inventory gui = Bukkit.createInventory(null, 54, ChatColor.DARK_BLUE + "OPItems recipe");
        ...
        emptyMeta.getPersistentDataContainer().set(NameSpaces.opitemsGui, PersistentDataType.STRING, "r_gui_locked");
        ...
        for (int i = 0; i < 9; i++) {
            ...
            rMeta.getPersistentDataContainer().set(NameSpaces.opitemsGui, PersistentDataType.STRING, "r_gui_locked");
        ...
        if (isEnabled) {
            ...
            enabledMeta.setDisplayName(ChatColor.GREEN + "This item is enabled");
            enabledMeta.getPersistentDataContainer().set(NameSpaces.opitemsGui, PersistentDataType.STRING, "r_gui_locked");
            ...
            enabledMeta.setDisplayName(ChatColor.RED + "This item is disabled");
            enabledMeta.getPersistentDataContainer().set(NameSpaces.opitemsGui, PersistentDataType.STRING, "r_gui_locked");
